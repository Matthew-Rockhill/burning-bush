...
const colors = {
  ...
  flame: 'bg-bb-flame-magenta/20 text-bb-flame-magenta group-data-hover:bg-bb-flame-magenta/30 dark:bg-bb-flame-magenta/15 dark:text-bb-flame-pink dark:group-data-hover:bg-bb-flame-magenta/25',
}
